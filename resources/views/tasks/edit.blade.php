                  ...
                  <div class="panel-body">
                      ...
                      <form action"{{ route('tasks.edit', ['id' => $task->folder_id, 'task_id' => $task->id])}}"
                          ...
                          <div class="text-right">
                              <button type="submit" class="btn btn-brimary">送信</button>
                          </div>
                      </form>
                  </div>
              </nav>
...
@section('scripts')
  ...
  <script src="https://npncdn.com/flatpickr/dist/l10n/ja.js"></script>
  <script>
  flatpickr(document.getElemtById('due_date'), {
      locale: 'ja',
      dateFormat: "Y/m/d",
      minDate: new Date()
  });
